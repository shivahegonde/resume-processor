package com.example.resumeprocessor.routes;
...
@Component
public class WordResumeProcessor extends RouteBuilder{
	...
	public void configure() throws Exception {
		...
		.split(body())
		.threads()
		.log("processing files for given directory")
	...
	private static String readWordFileUsingApacheTika(String filePath) throws IOException {
